...
class pyObjViewer(pyGLLib.GLApp):
    ...
    def main(self, points=None):
        ...
        charizard = GLObj("Models/Charizard.obj")
        charizard.load()
        pikachu = GLObj("Models/pikachu.obj")
        pikachu.load()
        ...
        self.add_object("charizard", charizard)
        self.add_object("pikachu", pikachu)
        self.run()
        self.cleanup()
