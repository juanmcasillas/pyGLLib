...
#
# pyCubeText.py
# trying to load a texture in the cube.
...
class pyCubeText(pyGLLib.GLApp):
    ...
    def render(self):
        ...
        self.shaders[shader].setVec3(b'objectColor',(1.0,1.0,1.0))
    ...
    def main(self):
        ...
        cube = pyGLLib.object.GLCubeEXT()
        cube.load()
        cube.add_texture(pyGLLib.texture.GLTexture("Models/Textures/wall.jpg").load())
...
if __name__ == "__main__":
    ...
    app = pyCubeText( (800,600), "PyGLLib Sample App")
    app.main()
